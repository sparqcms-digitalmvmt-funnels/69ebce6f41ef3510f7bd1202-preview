...
const KLAVIYO_PUBLIC_API_KEY = 'WFjs8a';
const KLAVIYO_LIST_ID = 'TCsGWa';
...
function getNextPageSlugForRedirect() {
  const normalize = (value) => {
    if (!value) return "";
    return value.startsWith("/69ebce6f41ef3510f7bd1202-preview") ? value : (value.startsWith("/") ? "/69ebce6f41ef3510f7bd1202-preview" + value : "/69ebce6f41ef3510f7bd1202-preview/" + value);
  };
...
const getVrioCampaignInfoBasedOnPaymentMethod = (isVipUpsell) => {
    const vrioCampaigns = [{"_id":"69ebce4f41ef3510f7bd11f2","integration":[{"_id":"68de8b4ba7998abc5f77b02a","workspace":"develop","platform":"vrio","description":"production","fields":{"publicApiKey":"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzY29wZSI6ImFkbWluIiwib3JnYW5pemF0aW9uIjoibXZtdC52cmlvIiwiaWQiOiJhZTE4OGY0ZC0yMDAwLTQ4ZWItOGE4YS03OGY1ZjBiMWQxZGMiLCJpYXQiOjE3NTU3MjQ1OTIsImF1ZCI6InVybjp2cmlvOmFwaTp1c2VyIiwiaXNzIjoidXJuOnZyaW86YXBpOmF1dGhlbnRpY2F0b3IiLCJzdWIiOiJ1cm46dnJpbzphcGk6MjIifQ.51xFtExTqVm3o2mhizx3VsiSTv7pNAB6beF1rmV_-Jg","internalApiKey":"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzY29wZSI6ImFkbWluIiwib3JnYW5pemF0aW9uIjoibXZtdC52cmlvIiwiaWQiOiJhZTE4OGY0ZC0yMDAwLTQ4ZWItOGE4YS03OGY1ZjBiMWQxZGMiLCJpYXQiOjE3NTU3MjQ1OTIsImF1ZCI6InVybjp2cmlvOmFwaTp1c2VyIiwiaXNzIjoidXJuOnZyaW86YXBpOmF1dGhlbnRpY2F0b3IiLCJzdWIiOiJ1cm46dnJpbzphcGk6MjIifQ.51xFtExTqVm3o2mhizx3VsiSTv7pNAB6beF1rmV_-Jg"},"status":"active","createdAt":1758437407128,"updatedAt":1759415115447,"__v":0,"category":"CRM","id":"68de8b4ba7998abc5f77b02a"}],"externalId":"285","name":"Vital Shoulder Massager - Network - (1)","currency":"USD","countries":[223,38],"metadata":{"campaign_id":285,"campaign_name":"","payment_type_id":1,"campaign_active":true,"campaign_prepaid":true,"campaign_payment_method_required":true,"campaign_group_transactions":true,"campaign_global_js":"","campaign_global_seo_title":"","campaign_global_seo_keywords":"","campaign_global_seo_description":"","date_created":"2026-04-24 20:10:55","created_by":0,"date_modified":"2026-04-24 20:10:55","modified_by":0,"campaign_notes":"","offers":[],"shipping_profiles":[],"campaignId":"285","externalId":285,"description":"","payment_methods":["amex","discover","visa","master"],"alternative_payments":[],"countries":[{"iso_numeric":840,"calling_code":"1","id":223,"name":"United States of America","iso_2":"US","iso_3":"USA"},{"iso_numeric":124,"calling_code":"1","id":38,"name":"Canada","iso_2":"CA","iso_3":"CAN"}]},"funnels":[],"createdAt":1777022621210,"updatedAt":1777061455859,"packages":[],"status":"active","platform":"vrio","__v":0,"id":"69ebce4f41ef3510f7bd11f2"}];
...
const getPrices = () => {
  return [{"name":"VIP Customer Benefits","id":26,"quantity":1,"price":24.99,"shippable":false,"fullPrice":24.99,"finalPrice":24.99,"productName":"VIP Customer Benefits","discountAmount":0,"discountPercentage":0},{"name":"1x Vital Shoulder Massager","id":1936,"quantity":1,"price":0,"shippable":false,"fullPrice":59.99,"finalPrice":59.99,"productName":"1x Vital Shoulder Massager","discountAmount":0,"discountPercentage":0},{"name":"2x Vital Shoulder Massager","id":1937,"quantity":1,"price":0,"shippable":false,"fullPrice":99.99,"finalPrice":99.99,"productName":"2x Vital Shoulder Massager","discountAmount":0,"discountPercentage":0},{"name":"3x Vital Shoulder Massager","id":1938,"quantity":1,"price":0,"shippable":false,"fullPrice":129.99,"finalPrice":129.99,"productName":"3x Vital Shoulder Massager","discountAmount":0,"discountPercentage":0},{"name":"4x Vital Shoulder Massager","id":1939,"quantity":1,"price":0,"shippable":false,"fullPrice":149.99,"finalPrice":149.99,"productName":"4x Vital Shoulder Massager","discountAmount":0,"discountPercentage":0},{"name":"Porch Pirate - Guarantee","id":2052,"quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"Porch Pirate - Guarantee","discountAmount":0,"discountPercentage":0},{"name":"Special 1x EXTRA Vital Shoulder Massager","id":1942,"quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"Special 1x EXTRA Vital Shoulder Massager","discountAmount":0,"discountPercentage":0},{"name":"Special 1x EXTRA Vital Shoulder Massager","id":1943,"quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"Special 1x EXTRA Vital Shoulder Massager","discountAmount":0,"discountPercentage":0},{"name":"Vital Shoulder Massager   Journey Package Protection","id":1941,"quantity":1,"price":0,"shippable":false,"fullPrice":3.5,"finalPrice":3.5,"productName":"Vital Shoulder Massager   Journey Package Protection","discountAmount":0,"discountPercentage":0},{"name":"Vital Shoulder Massager - 3 Year Warranty","id":1940,"quantity":1,"price":0,"shippable":false,"fullPrice":9.95,"finalPrice":9.95,"productName":"Vital Shoulder Massager - 3 Year Warranty","discountAmount":0,"discountPercentage":0}]
};
...
async function createOrderViaWallet(confirmationToken, paymentMethodId) {
  ...
  const orderData = {
    pageId: "sXai4QHcdmpbGegAOF22GbcPhGiZehIjzZglgxd3XGiZSbEG9AN8dLNqKa5SbIEr",
    action: "process",
  ...
  MVMT.track("ORDER_SUBMITTED", {
    page: "Vital Shoulder Massager - Checkout",
    page_type: "Checkout",
...
(function() {
  try {
    var klaviyoLifecyclePayload = {
      ...
      timestamp: Date.now(),
      location: "builder-events/checkout/vrio-checkout-js-generator.ts" + ':KlaviyoLifecycle:initialized',
      message: 'Klaviyo lifecycle: initialized',
      runId: 'initial',
      hypothesisId: 'KlaviyoLifecycle',
      data: {
        pageName: "Vital Shoulder Massager - Checkout",
        pageType: "Checkout",
...
function logKlaviyoTrace(step, data) {
  ...
  try {
    var payload = {
      id: 'log_' + Date.now() + '_' + Math.random().toString(16).slice(2, 8),
      timestamp: Date.now(),
      location: "builder-events/checkout/vrio-checkout-js-generator.ts" + ':KlaviyoTrace',
...
const getStates = async (countryIso2Code) => {
  ...
  try {
    if (!countriesStatesCache) {
      const res = await fetch('/69ebce6f41ef3510f7bd1202-preview/scripts/countriesData/countriesStates.json', { cache: 'no-store' });
...
if (typeof validateAndSendToKlaviyo === "function") {
  try {
    ...
    var pageReadyPayload = {
      ...
      runId: "initial",
      hypothesisId: "KlaviyoLifecycle",
      data: { pageName: "Vital Shoulder Massager - Checkout", pageType: "Checkout" },
    };
