...
(function() {
  try {
    var klaviyoLifecyclePayload = {
      ...
      data: {
        pageName: "Vital Shoulder Massager - Thank You",
        pageType: "ThankYou",
    ...
    data: {
      ...
      attributes: {
        ...
        properties: {
          ...
          source,
          page: "Vital Shoulder Massager - Thank You",
          page_type: "ThankYou",
...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  const endpoint =
    ...
    `&with=order_offers,customer_address_billing,customer_address_shipping,customer,transactions,cart&pageId=na7w1ai6QTOgfbJ0rTknhveS4mpj8Y9lkXsOs-nBi_9jKcxjpHmcrxgBqsYjKlB9`
